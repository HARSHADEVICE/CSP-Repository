---
keywords: fastai
description: Showing Java outputs
title: JavaScript Jupyter Notebook
toc: true
badges: false
permalink: /jupyter/javascript
categories: [fastpages, jupyter]
nb_path: _notebooks/2022-09-25-Java-Notebook.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2022-09-25-Java-Notebook.ipynb
-->
...
<div class=" highlight hl-javascript"><pre><span></span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s2">&quot;Harsha&quot;</span><span class="p">)</span>
</pre></div>
...
<div class="text_cell_render border-box-sizing rendered_html">
<ul>
<li>This command uses console.log and displays my name. </li>
<li>This is similar to print in Python as we discussed in class.</li>
</ul>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-javascript"><pre><span></span><span class="kd">var</span> <span class="nx">name</span> <span class="o">=</span> <span class="s2">&quot;Harsha&quot;</span><span class="p">;</span>
...
<div class="text_cell_render border-box-sizing rendered_html">
<ul>
<li>This shows usage of a variable in Javascript</li>
<li>It stores my name, Harsha, in a variable called message. It prints out the variable thereby printing out my name.</li>
</ul>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-javascript"><pre><span></span><span class="kd">function</span> <span class="nx">display_Harsha</span><span class="p">(</span><span class="nx">output</span><span class="p">)</span> <span class="p">{</span>
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">output</span><span class="p">);</span>
<span class="p">}</span>
<span class="nx">display_Harsha</span><span class="p">(</span><span class="nx">name</span><span class="p">);</span>
</pre></div>
...
<div class="text_cell_render border-box-sizing rendered_html">
<ul>
<li>This shows use of a function which displays my name (because name is a value previously used in the file).</li>
<li>display_Harsha(name) calls the function, displaying "Harsha". </li>
<li>function display_Harsha(output) is the code to define the function.</li>
</ul>
...
<span class="nx">logItType</span><span class="p">(</span><span class="s2">&quot;hello world&quot;</span><span class="p">);</span> 
<span class="nx">logItType</span><span class="p">(</span><span class="mf">2022</span><span class="p">);</span>    
<span class="nx">logItType</span><span class="p">([</span><span class="mf">2</span><span class="p">,</span><span class="mf">4</span><span class="p">,</span><span class="mf">6</span><span class="p">,</span><span class="mf">8</span><span class="p">,</span><span class="mf">10</span><span class="p">,</span><span class="mf">12</span><span class="p">]);</span>
</pre></div>
...
<div class="text_cell_render border-box-sizing rendered_html">
<ul>
<li>This shows usage of dynamic nature of types in Javascript (making sure everything works as supposed to).</li>
</ul>
...
<div class="text_cell_render border-box-sizing rendered_html">
<ul>
<li>The definition of function allows for a collection of data, the function (Person) allows the user  to retain the name, github id, and class of designation.</li>
<li>The (Person.prototype.toJSON) allows the collection of data to be expressed in a json/string versus JavaScript object.</li>
</ul>
...
<span class="kd">var</span> <span class="nx">students</span> <span class="o">=</span> <span class="p">[</span> 
    <span class="k">new</span> <span class="nx">Person</span><span class="p">(</span><span class="s2">&quot;Harsha&quot;</span><span class="p">,</span> <span class="s2">&quot;HARSHADEVICE&quot;</span><span class="p">,</span> <span class="mf">2025</span><span class="p">),</span>
    <span class="k">new</span> <span class="nx">Person</span><span class="p">(</span><span class="s2">&quot;Tanay&quot;</span><span class="p">,</span> <span class="s2">&quot;tanayp327&quot;</span><span class="p">,</span> <span class="mf">2025</span><span class="p">),</span>
    <span class="k">new</span> <span class="nx">Person</span><span class="p">(</span><span class="s2">&quot;Yuri&quot;</span><span class="p">,</span> <span class="s2">&quot;yuricoder07&quot;</span><span class="p">,</span> <span class="mf">2025</span><span class="p">),</span>
    <span class="k">new</span> <span class="nx">Person</span><span class="p">(</span><span class="s2">&quot;Raunak&quot;</span><span class="p">,</span> <span class="s2">&quot;raunak2007&quot;</span><span class="p">,</span> <span class="mf">2025</span><span class="p">)</span>
...
<div class="text_cell_render border-box-sizing rendered_html">
<ul>
<li>Building an Array, "var students" is an array that contains many people. </li>
<li>Building a Classroom, this showsfor Each iteration through an array and .push adding to an array. This is important</li>
</ul>
...
<div class="text_cell_render border-box-sizing rendered_html">
<ul>
<li>Formatted the table using the persons function from earlier. Used tr for table rows, th for table headings, and td for table data and created the table.</li>
</ul>
