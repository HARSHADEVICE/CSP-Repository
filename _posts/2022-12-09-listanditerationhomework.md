...
toc: true
permalink: /homework/
nb_path: _notebooks/2022-12-5-listanditerationhomework.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2022-12-5-listanditerationhomework.ipynb
-->
...
<ul>
<li>Lists are a collection of data.</li>
...
<div class="text_cell_render border-box-sizing rendered_html">
<ul>
<li>I tried coding the homework and have put effort into it. But for some reason it is not working and I could not figure it out. It does not output anything.</li>
</ul>
...
<span class="n">questions</span> <span class="o">=</span> <span class="p">[</span>
    <span class="s2">&quot;What is a list?&quot;</span><span class="p">,</span> <span class="s2">&quot;A. Something that repeats code&quot;</span><span class="p">,</span> <span class="s2">&quot;B. A To-do List&quot;</span><span class="p">,</span> <span class="s2">&quot;C. Things that are meant to store data&quot;</span><span class="p">,</span> <span class="s2">&quot;C&quot;</span>
    <span class="s2">&quot;What is a loop?&quot;</span><span class="p">,</span> <span class="s2">&quot;A. Something that collects data&quot;</span><span class="p">,</span><span class="s2">&quot;B. A time loop&quot;</span><span class="p">,</span> <span class="s2">&quot;C. A feature that repeats a block of code as per user&quot;</span><span class="p">,</span> <span class="s2">&quot;C&quot;</span><span class="p">,</span>
    <span class="s2">&quot;What are indexes?&quot;</span><span class="p">,</span> <span class="s2">&quot;A. Something at the end of a book&quot;</span><span class="p">,</span> <span class="s2">&quot;B. A feature used to iterate in lists&quot;</span><span class="p">,</span> <span class="s2">&quot;C. Something in Math&quot;</span><span class="p">,</span> <span class="s2">&quot;B&quot;</span>
    <span class="s2">&quot;What is the function used to add elements in lists?&quot;</span><span class="p">,</span> <span class="s2">&quot;A. Append&quot;</span><span class="p">,</span> <span class="s2">&quot;B. Pop&quot;</span><span class="p">,</span> <span class="s2">&quot;C. Remove&quot;</span><span class="p">,</span> <span class="s2">&quot;A&quot;</span>
    <span class="s2">&quot;What is the index of the starting point of a list?&quot;</span><span class="p">,</span> <span class="s2">&quot;A. 1&quot;</span><span class="p">,</span> <span class="s2">&quot;B. 0&quot;</span><span class="p">,</span> <span class="s2">&quot;C. 5&quot;</span><span class="p">,</span> <span class="s2">&quot;B&quot;</span>
<span class="p">]</span>
...
<span class="k">def</span> <span class="nf">questionloop</span><span class="p">():</span>
   ...
   <span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="nb">len</span><span class="p">(</span><span class="n">questions</span><span class="p">)):</span>
    <span class="n">answer</span> <span class="o">=</span> <span class="nb">input</span><span class="p">(</span><span class="s2">&quot;Input option&quot;</span><span class="p">)</span>
    <span class="k">if</span> <span class="n">answer</span> <span class="o">==</span> <span class="n">questions</span><span class="p">[</span><span class="n">i</span><span class="p">]:</span> 
...
<span class="n">middle_list</span> <span class="o">=</span> <span class="p">[]</span> <span class="c1"># acts as a placeholder</span>
<span class="n">comverted_list</span><span class="o">=</span><span class="p">[]</span> <span class="c1"># the final list that accounts for values less than 100</span>
<span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="n">binarylist</span><span class="p">:</span>
    <span class="n">middle_list</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="nb">int</span><span class="p">(</span><span class="n">i</span><span class="p">,</span> <span class="mi">2</span><span class="p">))</span> <span class="c1"># converts the numbers into binary form</span>
<span class="k">for</span> <span class="n">value</span> <span class="ow">in</span> <span class="n">middle_list</span><span class="p">:</span> 
    <span class="k">if</span> <span class="n">value</span> <span class="o">&lt;=</span> <span class="mi">100</span><span class="p">:</span>
        <span class="n">comverted_list</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">value</span><span class="p">)</span>
<span class="nb">print</span><span class="p">(</span><span class="s2">&quot;The converted list is: &quot;</span> <span class="p">,</span>  <span class="n">comverted_list</span><span class="p">)</span> <span class="c1"># prints out final converted list for values greater than or equal to 100</span>
</pre></div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>The converted list is:  [73, 55]
</pre>
</div>
</div>
